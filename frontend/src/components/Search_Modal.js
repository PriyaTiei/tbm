...
import { filterCardNo, filterProcessNo } from "../redux/filter/filterActions";
// import { toast } from "react-toastify";
function Search_Modal({ showModal, setShowModal, workDetail, itemId }) {
  ...
  return (
    <Modal show={showModal} onHide={handleClose}>
      <Modal.Header closeButton>
        <Modal.Title>Search TBM/Smile cards</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div>
          ...
          <form onSubmit={formHandler} className="form-group mx-3">
            ...
            <div className="d-flex justify-content-betweem my-2">
              <div className="me-3 d-flex flex-column">
                <label className="me-1" htmlFor="op">
                  OP number
                </label>
                <input
                  type="text"
              ...
              <div className="me-3 d-flex flex-column">
                <label className="me-1" htmlFor="cardNo">
                  Card number
                </label>
                <input
                  type="text"
