...
urlForCardRaised="http://10.82.126.73:5051/card/find/fromDate/"+str(f_y)+"-"+str(f_m)+"-"+str(f_d)+"/toDate/"+str(t_y)+"-"+str(t_m)+"-"+str(t_d)
urlForCardRaised_4_yesterday="http://10.82.126.73:5051/card/find/fromDate/"+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"/toDate/"+str(y)+"-"+str(m)+"-"+str(d)
...
url4mcDetails="http://10.82.126.73:5051/head/headMachineList?d="+str(y_weekd)+"&y="+str(y_y)+"&w="+str(y_weekNo)+"&m="+str(y_m)+"&pS=P"
url4dailyStatus="http://10.82.126.73:5051/dailyStatus?entryFor="+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"&pS=P"
url4mcDetails_OM="http://10.82.126.73:5051/head/headMachineList?d="+str(y_weekd)+"&y="+str(y_y)+"&w="+str(y_weekNo)+"&m="+str(y_m)+"&pS=S"
url4dailyStatus_OM="http://10.82.126.73:5051/dailyStatus?entryFor="+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"&pS=S"
print(url4mcDetails)
...
total_line_list_mnt=["Assembly (Block Sub-assembly)", "Assembly (Head Sub-assembly)","Assembly (MK-1)", "Assembly (MK-2)","Assembly (Piston Sub-assembly)","Assembly (Test Bench)", "Block", "Crank", "Head"]
...
total_line_list_prod=["Assembly (Block Sub-assembly)", "Assembly (Head Sub-assembly)","Assembly (MK-1)", "Assembly (MK-2)","Assembly (Piston Sub-assembly)","Assembly (Test Bench)", "Block", "Crank", "Head"]
