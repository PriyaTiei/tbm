...
urlForCardRaised="http://10.82.126.73:5071/card/find/fromDate/"+str(f_y)+"-"+str(f_m)+"-"+str(f_d)+"/toDate/"+str(t_y)+"-"+str(t_m)+"-"+str(t_d)
urlForCardRaised_4_yesterday="http://10.82.126.73:5071/card/find/fromDate/"+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"/toDate/"+str(y)+"-"+str(m)+"-"+str(d)
...
if card["success"]==True:
    ...
    for entry in card_list:
        if entry["line"]=="Block" and entry["status"]!="complete":
            ...
            dateCreated=date(int(entry["createdAt"][0:4]),int(entry["createdAt"][5:7]),int(entry["createdAt"][8:10]))
...
url4mcDetails="http://10.82.126.73:5071/head/headMachineList?d="+str(y_weekd)+"&y="+str(y_y)+"&w="+str(y_weekNo)+"&m="+str(y_m)+"&pS=P"
url4dailyStatus="http://10.82.126.73:5071/dailyStatus?entryFor="+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"&pS=P"
url4mcDetails_OM="http://10.82.126.73:5071/head/headMachineList?d="+str(y_weekd)+"&y="+str(y_y)+"&w="+str(y_weekNo)+"&m="+str(y_m)+"&pS=S"
url4dailyStatus_OM="http://10.82.126.73:5071/dailyStatus?entryFor="+str(y_y)+"-"+str(y_m)+"-"+str(y_d)+"&pS=S"
print(url4mcDetails)
...
for i in mcDetails["machineData"]:
    ...
    ok_p=0
    ng_p=0
total_line_list_mnt=[ "Block", "Crank", "Head" ]
...
for i in mcDetails_OM["machineData"]:
    ...
    ok_p=0
    ng_p=0
total_line_list_prod=[ "Block", "Crank", "Head" ]
...
"manjunatha.agali@tiei.toyota-industries.com","manojkumar@tiei.toyota-industries.com","sundeep@tiei.toyota-industries.com"]
...
<p>
Good Morning<br> 
SUMMARY OF PREVIOUS DAY <b>(%s)</b> TBM CHECK ACTIVITY IN TNGA<br> 
</p>
<p>    
...
#"manjunatha.ramadas@tiei.toyota-industries.com",
#"nagendra.ks@tiei.toyota-industries.com",
"raghavendra.singh@tiei.toyota-industries.com", "sureshkumarms@tiei.toyota-industries.com", "dharmendra.p@tiei.toyota-industries.com", "kannan.r@tiei.toyota-industries.com",
"ravivarma.n@tiei.toyota-industries.com", "anjineya.b@tiei.toyota-industries.com", "ranjith.nittur@tiei.toyota-industries.com", "gurunath.mn@tiei.toyota-industries.com",
"mounesh.m@tiei.toyota-industries.com", "srinath.waiker@tiei.toyota-industries.com", "srharidas@tiei.toyota-industries.com", "yousuf@tiei.toyota-industries.com",
"pankaj.jogi@tiei.toyota-industries.com","abhishek.k@tiei.toyota-industries.com", "nithish.cr@tiei.toyota-industries.com","madhusudhan.h@tiei.toyota-industries.com"
]
...
# Setup of MIMEMultipart Object Header
message['From'] = "pankaj.jogi@tiei.toyota-industries.com"
message['To'] = "ravivarma.n@tiei.toyota-industries.com","pankaj.jogi@tiei.toyota-industries.com"
#message['To'] = ', '.join(family)
message['Subject'] = "TNGA-PROD Daily Smile card status"
...
<p>
Good Morning<br> 
SUMMARY OF PREVIOUS DAY <b>(%s)</b> SMILE CARD CHECK ACTIVITY IN TNGA<br> 
</p>
<p>
<b>TNGA-PRODUCTION</b>
    %s
...
""" % (yesterday_date,my_message)

textPart1=MIMEText(html,'html')

# Creation of a MIMEApplication Part

#card summery attaching
